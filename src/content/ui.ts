...
const en = {
  ...
  summary: {
    ...
    qrSub: "They can scan this code or open the link to see this summary. The information travels inside the link — it is not stored on a server.",
  ...
  recheck: {
    ...
    newFlagsTitle: "Any new warning signs since last time?",
...
const es: UIStrings = {
  ...
  summary: {
    ...
    qrSub: "Pueden escanear este código o abrir el enlace para ver este resumen. La información viaja dentro del enlace — no se guarda en ningún servidor.",
  ...
  recheck: {
    ...
    newFlagsTitle: "¿Hay nuevos signos de alarma desde la última vez?",
