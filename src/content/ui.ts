...
const en = {
  ...
  start: {
    ...
    injuryWhen: "When did it happen?",
    injuryJustNow: "Just now",
    injuryEarlierToday: "Earlier today",
    injuryYesterday: "Yesterday",
    injuryDaysAgo: "A few days ago",
    injuryExact: "Set exact date & time",
...
const es: UIStrings = {
  ...
  start: {
    ...
    injuryWhen: "¿Cuándo ocurrió?",
    injuryJustNow: "Ahora mismo",
    injuryEarlierToday: "Hoy, más temprano",
    injuryYesterday: "Ayer",
    injuryDaysAgo: "Hace unos días",
    injuryExact: "Indicar fecha y hora exactas",
